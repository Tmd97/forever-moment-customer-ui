...
import EventThemesPreview from './components/EventThemesPreview';

const BalloonDecorContainer = (props: any) => {
    return <EventThemesPreview {...props} />;
};
...
export default connect(mapStateToProps, mapDispatchToProps)(BalloonDecorContainer);